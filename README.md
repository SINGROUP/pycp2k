...
6. All the repeatable items X have one accessible object by default. Additional items have to be added with a function 'add_X'. For sections this function returns a reference to the newly created object which you should store into a new variable for later access. The list of repeateable item can be accessed from attribute 'listX'

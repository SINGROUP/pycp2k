...
from ._pair_potential5 import _pair_potential5
from ._non_local5 import _non_local5


class _vdw_potential5(InputSection):
    def __init__(self):
        ...
        self._repeated_subsections = {'PAIR_POTENTIAL': '_pair_potential5', 'NON_LOCAL': '_non_local5'}
